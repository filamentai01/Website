...
const ServicesCardMobile = (props: any) => {

    return (
        
        <div  className="mt-4" >
           
            <div className="content-header mb-3 mt-2 font-face-subtitle-mobile">
                {
            ...
            <img className="content-img"
                ...
                alt="content" />
            <div className="content-text font-face-body-mobile mb-2">
                {
                    props?.target == 'facialRecognition' ?
